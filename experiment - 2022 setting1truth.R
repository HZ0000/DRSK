...
for (i in 1:samplesize) {
  #print(i)
  aa1 <- rgamma(1, shape=20, scale = 1/0.5)
  aa2 <- rgamma(1, shape=20, scale = 1/0.7)
  input_raw <- c(aa1, aa2)
  ...
  input_raw <- c(input_raw, rgamma(1, shape=20, scale = 1/0.8))
...
write.csv(arr_in, file = "CF1-truth.csv")
